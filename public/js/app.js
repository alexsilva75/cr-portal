...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); ////console.log("Vue Instance: ", Vue);
  ...
  methods: {
    ...
    setLocation: function setLocation(lat, lng) {
      ...
      map.addEventListener("click", function (event) {
        ...
        marker.setLatLng(L.latLng(lat, lng)); // const latInputEl = document.getElementById("inputLat");
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log("Name ", _this3.name);
                requestBody = {
                  name: _this3.name,
                  surname: _this3.surname,
                  email: _this3.email,
                  cpf_cnpj: _this3.cpf_cnpj,
                  birthdate: _this3.birthdate,
                  address: _this3.address,
                  address_number: _this3.address_number,
                  neighborhood: _this3.neighborhood,
                  address_reference: _this3.address_reference,
                  city: _this3.city,
                  phone: _this3.phone,
              ...
              case 5:
                ...
                if (response.status === 200) {
                  showToaster("Sua inscrição foi realizada!", "Em breve entraremos em contato para ajustar os detalhes da sua instalação.", "success");
                } else {
                  showToaster("Houve um erro ao tentar enviar os seus dados!", "Tente novamente mais tarde.", "danger");
                }
